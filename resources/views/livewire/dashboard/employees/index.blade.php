					...
					<div class="form">
						...
						<div class="row">
							...
							<div class="form-group col">
								...
								<input wire:model="email_verified_at" type="text" id="email_verify" class="form-control" disabled="" />
								<!-- value="@if(!empty($user['email_verified_at'])) Yes @else No @endif" -->
							</div>
						</div>
						<!-- <div class="form-group">
							<label for="password" class="text-xs uppercase text-gray-400 font-bold">Password</label>
							<input wire:model="password" type="text" id="password" value="Hidden" class="form-control" disabled="" />
						</div> -->
					</div>
				</div>
